...
require([
  ...
  function(
    ...
    var infoTemplate = new InfoTemplate("${name}", "Date:  ${startDate} <br> Site: <a href=\"${url}\">${url}</a> <br> <img src=\"${iconUrl}\">");
    ...
    var featureLayer = new FeatureLayer
      ...
      ("https://services7.arcgis.com/9FC4Dk51iODnloBr/arcgis/rest/services/Hackathons/FeatureServer/0", {
    ...
    map.on("click", function(event){
      ...
      require(["esri/geometry/Point"], function(Point) { 
        point = new Point(event.mapPoint.x, event.mapPoint.y, event.mapPoint.spatialReference);
        // console.log(point);
      ...
      $.getJSON('/?lat=' + point.getLatitude() + '&long=' + point.getLongitude(), function(data) {
          console.log(data);
          ...
          var node = document.createTextNode(data.statuses[tweet].text);
      ...
      // fetch('/?lat=' + point.getLatitude() + '&long=' + point.getLongitude(), {
      //   method: 'get'
