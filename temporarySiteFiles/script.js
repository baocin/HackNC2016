...
require([
  ...
  function(
    ...
    var infoTemplate = new InfoTemplate("${name}: ${city}, ${state}", "Date:  ${startDate} <br> Site: ${url} <br> <img src=\"${iconUrl}\">");
    ...
    var featureLayer = new FeatureLayer
      ...
      ("https://services7.arcgis.com/9FC4Dk51iODnloBr/arcgis/rest/services/test/FeatureServer/0", {
